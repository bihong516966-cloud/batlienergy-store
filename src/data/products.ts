...
export const products: Product[] = [
  // ===== 1. Cylindrical Cells =====
  { id: 'samsung-25r', slug: 'samsung-25r-18650', name: 'Samsung 25R 18650', category: 'cylindrical', description: 'The most popular 18650 cell for power tools and e-bikes. Excellent balance of capacity and discharge rate.', specs: { Capacity: '2500mAh', Voltage: '3.6V', 'Max Discharge': '20A', Chemistry: 'Li-ion NMC', Weight: '47g' }, price: { b2b: { min: 1.0, max: 2.09, currency: 'USD' }, retail: { min: 2.5, max: 4.5, currency: 'USD' } }, moq: 100, images: [], certifications: ['UN38.3', 'CE'], inStock: true, badge: 'Best Seller' },
  { id: 'samsung-30q', slug: 'samsung-30q-18650', name: 'Samsung 30Q 18650', category: 'cylindrical', description: 'High-capacity 18650 cell ideal for flashlights, vaping devices, and power banks.', specs: { Capacity: '3000mAh', Voltage: '3.6V', 'Max Discharge': '15A', Chemistry: 'Li-ion NMC', Weight: '48g' }, price: { b2b: { min: 1.5, max: 2.5, currency: 'USD' }, retail: { min: 3.0, max: 5.0, currency: 'USD' } }, moq: 100, images: [], certifications: ['UN38.3', 'CE'], inStock: true },
  { id: 'samsung-35e', slug: 'samsung-35e-18650', name: 'Samsung 35E 18650', category: 'cylindrical', description: 'Ultra-high capacity 18650 for laptops, medical devices, and low-drain applications.', specs: { Capacity: '3500mAh', Voltage: '3.6V', 'Max Discharge': '10A', Chemistry: 'Li-ion NMC', Weight: '49g' }, price: { b2b: { min: 1.2, max: 2.2, currency: 'USD' }, retail: { min: 2.8, max: 4.8, currency: 'USD' } }, moq: 100, images: [], certifications: ['UN38.3', 'CE'], inStock: true },
  ...
  { id: '32650-6000', slug: '32650-6000mah-lifepo4', name: '32650 6000mAh LiFePO4', category: 'large-cylindrical', description: 'Large cylindrical LiFePO4 cell for solar street lights and small storage.', specs: { Capacity: '6000mAh', Voltage: '3.2V', 'Cycle Life': '2000-3000', Chemistry: 'LiFePO4', Weight: '145g', Dimensions: '32x65mm' }, price: { b2b: { min: 2.5, max: 6.0, currency: 'USD' }, retail: { min: 5, max: 10, currency: 'USD' } }, moq: 200, images: [], certifications: ['UN38.3', 'CE'], inStock: true },
  { id: '32700-7000', slug: '32700-7000mah-lifepo4', name: '32700 7000mAh LiFePO4', category: 'large-cylindrical', description: 'Ultra-high capacity cylindrical LiFePO4 for solar and storage applications.', specs: { Capacity: '7000mAh', Voltage: '3.2V', 'Cycle Life': '2000-4000', Chemistry: 'LiFePO4', Weight: '170g', Dimensions: '32x70mm' }, price: { b2b: { min: 2.0, max: 5.5, currency: 'USD' }, retail: { min: 4, max: 9, currency: 'USD' } }, moq: 200, images: [], certifications: ['UN38.3', 'CE'], inStock: true, badge: 'Popular' },
